...
class VariantTestCase(TestCase):
    ...
    def test_search_datasets_paging(self):
        # TODO make sure no next page token is set at least
        pass
    ...
    def test_search_variant_sets_request_validation(self):
        """Tests that variantsets search endpoint is alive."""
    ...
    def test_get_variant_by_id(self):
        ...
        # TODO first search for a variant then get it by id and make sure the fields are equivalent
    ...
    def test_origin(self):
        # TODO tests to see that the genomic coordinate and Hg3x_Start strings represent the 1-based
    ...
    def test_brca_to_ga4gh(self):
        ...
        """
        db_variant['Hg38_Start'] = 123L
        ga_variant = brca_to_ga4gh(db_variant)
        self.assertTrue(db_variant['Hg38_Start'] == ga_variant.start)
        """
